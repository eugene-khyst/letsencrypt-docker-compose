...
You can run Nginx with IPv4, IPv6, HTTP/1.1, and HTTP/2 support and set up HTTPS with Let's Encrypt TLS certificates for your domain names and get an A+ rating in [SSL Labs SSL Server Test](https://www.ssllabs.com/ssltest/) using Docker Compose and _letsencrypt-docker-compose_ CLI tool.
...
The idea is simple. There are three main containers:

- **Nginx**
- **Certbot** for obtaining and renewing certificates
- **Cron** for triggering certificates renewal once a day

and one additional container **CLI** for simple interactive configuration.
...
<p>
  <img width="600" src="./examples/initial-setup.svg">
</p>
...
## <a id="56ea677857821266b64c94ad4062f694"></a>Removing a domain name from a running solution

### <a id="9b06caa56a0ae7d96bfb5ab377cb36b5"></a>Step 1 - Remove the `.conf` file

Remove the `domain.to.remove.com.conf` file from `vhost`

### <a id="a5e2f88d13b7532a95f3e2b177fdd104"></a>Step 2 - Remove domain name

Remove the domain name from [`config.env`](config.env)

### <a id="e0a3ef1fe13feb2cea4d7a91e78ad899"></a>Step 3 - Update Docker containers
